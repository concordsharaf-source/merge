...
function productsMarkup() {
  ...
  return `${topbarMarkup("المنتجات", "ابحث بالاسم أو الباركود أو الكود الداخلي.", `<div class="topbar__actions"><button class="button button--secondary" data-action="navigate" data-view="inventory">${icon("layers", 17)}<span>المخزون</span></button></div>`)}
  ${saleSyncStrip()}
  ${productsHeroMarkup()}
